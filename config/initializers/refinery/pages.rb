...
Refinery::Pages.configure do |config|
  ...
  # config.friendly_id_reserved_words = ["index", "new", "session", "login", "logout", "users", "refinery", "admin", "images", "wymiframe", "location", "standards", "contacts", "references", "apartments", "callback"]
